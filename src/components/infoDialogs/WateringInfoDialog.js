...
class WateringInfoDialog extends React.Component {
    state = {
        period: '',
        address: '',
        name: '',
            ...
            >
                ...
                <DialogContent classes={{root: classes.dialogContentRoot}}>
                    <Typography
                        ...
                        variant='subheading'
                    >
                        <strong>Последний полив: {detectorInfo.timeofLastWatering}</strong>
                    </Typography>
                    <Typography
                        gutterBottom
                        variant='subheading'
                    ...
                    >
                        <strong>Влажность(%): {detectorInfo.humidity}</strong>
                    </Typography>
                    {!periodClicked ?
                        <Typography
                            gutterBottom
...
export default withStyles(styles)(WateringInfoDialog);
